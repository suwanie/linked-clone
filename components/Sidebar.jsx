    ...
    <div className="space-y-2 min-w-max max-w-lg">
      ...
      <div className="bg-white dark:bg-[#1D2226] rounded-lg overflow-hidden relative flex flex-col items-center text-center border border-gray-300 dark:border-none ">
        ...
        <div className="mt-5 py-4 space-x-0.5">
          {/* decoration은 hover 이벤트같이 마우스를 올리면, 여기선 보라색 언더라인이 생긴다. offset은 bottom을 줘서 공간을 만들어준다.*/}
        ...
        <div className="hidden md:inline text-left dark:text-white/75 text-sm">
          <div className="font-medium sidebarButton space-y-0.5">
            <div className="flex justify-between space-x-2">
              ...
              <span className="text-blue-500">204</span>
            </div>
            {/* 이친구는 space x 2 가 필요가 없는거 같기도 하고? */}
            <div className="flex justify-between space-x-2">
              <h4>Views of your post</h4>
              <span className="text-blue-500">721</span>
            </div>
          </div>
          ...
          <div className="sidebarButton">
            ...
            <h4 className="dark:text-white font-medium">
              {/* from - to 는 try 옆에보면 작은 네모칸으로 색이 변하는 것을 볼 수 있다. 색이 변하는 모양은  bg-gradient-to-somethin 이것으로 조절할 수 있다. */}
      ...
      {/* bottom */}
      {/* 이게 화면을 내렸을 때 고정되는 그건데, header와의 틈은 top으로 주는 것이다. */}
      <div className="hidden md:flex bg-white dark:bg-[#1D2226] text-black/70 dark:text-white/75 rounded-lg overflow-hidden flex-col space-y-2.5 pt-2.5 sticky top-20 border border-gray-300 dark:border-none">
